...
"""Modification of the ACME DDPG agent implementation.

Extend the ACME DDPG implementation with custom policy and critic learning_rate
parameters.
"""
...
from bbwrl.utils.modified_learning import ModifiedDDPGLearner


class ModifiedDDPG(agent.Agent):
  """DDPG Agent.
  ...
  def __init__(self,
    ...
    # Create optimizers.
    policy_optimizer = snt.optimizers.Adam(learning_rate=policy_learning_rate)
    critic_optimizer = snt.optimizers.Adam(learning_rate=critic_learning_rate)

    # The learner updates the parameters (and initializes them).
    learner = ModifiedDDPGLearner(
